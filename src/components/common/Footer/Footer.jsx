  ...
  return (
    <footer className="relative overflow-hidden" style={{ background: 'linear-gradient(180deg, #0a1628 0%, #0d1f3c 50%, #0a1628 100%)' }}>
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-6xl pt-16 pb-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-14">
          ...
          <div className="space-y-5 sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-2.5 pt-1">
              <a href={SOCIAL_LINKS.facebook} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/[0.06] border border-white/[0.08] flex items-center justify-center text-slate-400 hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 hover:-translate-y-0.5" aria-label="Facebook">
              ...
              <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/[0.06] border border-white/[0.08] flex items-center justify-center text-slate-400 hover:bg-[#E4405F] hover:text-white hover:border-[#E4405F] hover:shadow-lg hover:shadow-pink-500/20 transition-all duration-300 hover:-translate-y-0.5" aria-label="Instagram">
              ...
              <a href={SOCIAL_LINKS.youtube} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/[0.06] border border-white/[0.08] flex items-center justify-center text-slate-400 hover:bg-[#FF0000] hover:text-white hover:border-[#FF0000] hover:shadow-lg hover:shadow-red-500/20 transition-all duration-300 hover:-translate-y-0.5" aria-label="YouTube">
        ...
        {/* Developer Credit */}
        <div className="border-t border-white/[0.06] pt-5 pb-2 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-500/10 via-yellow-400/5 to-amber-500/10 border border-amber-400/25 shadow-lg shadow-amber-500/10 backdrop-blur-sm">
            <svg className="w-3 h-3 text-amber-400 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z"/></svg>
            <p className="text-[11.5px] text-amber-200/70 tracking-wide">
              Website Developed by{' '}
              <a
                href="https://ajlegalconsultant.in/services/business-website"
                target="_blank"
                rel="noopener noreferrer"
                className="text-amber-300 hover:text-white font-semibold transition-colors duration-300 hover:underline underline-offset-2"
              >
                Aj Legal Consultant (I) Private Limited
              </a>
            </p>
            <svg className="w-3 h-3 text-amber-400 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z"/></svg>
          </div>
