          ...
          <div className="flex-1 overflow-y-auto py-5 px-4 flex flex-col gap-6">
            ...
            <div className="mt-auto pt-5 border-t border-slate-100 flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2.5 px-2 text-xs text-slate-500">
                ...
                <a href={`https://wa.me/${CONTACT_INFO.whatsApp}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-[#25D366]">
                  <svg className="w-3.5 h-3.5 text-slate-400" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.272-.099-.47-.149-.669.149-.198.297-.768.967-.941 1.165-.173.198-.347.223-.644.074-.297-.149-1.255-.462-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.297-.347.446-.521.149-.174.198-.297.297-.496.099-.198.05-.372-.025-.521-.074-.148-.669-1.611-.916-2.206-.242-.579-.487-.5-.669-.51-.173-.008-.372-.01-.571-.01-.198 0-.521.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.073.149.198 2.098 3.2 5.076 4.487.709.306 1.262.49 1.694.625.712.227 1.36.195 1.872.118.572-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.174-1.413-.074-.123-.272-.198-.569-.347zM12.002 2C6.484 2 2 6.482 2 12c0 2.085.684 4.02 1.847 5.6L2 22l4.5-1.183A9.95 9.95 0 0012.002 22C17.52 22 22 17.518 22 12c0-5.518-4.48-10-9.998-10z" />
                  </svg>
